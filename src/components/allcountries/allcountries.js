    ...
    render() {
        return (
            <section className="allCountryList">
                <h2 className="text-dark">All Countries <span className="badge badge-secondary">{this.state.length}</span></h2>
                <nav className="navbar filterRow text-white bg-dark my-4">
